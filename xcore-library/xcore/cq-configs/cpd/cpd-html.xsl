<?xml version="1.0" encoding="UTF-8"?><!-- Stylesheet to turn the XML output of CPD into a nice-looking HTML page --><!-- $Id$ -->
    ...
    <xsl:template match="pmd-cpd">
        <html>
            ...
            <body>
                ...
                This page summarizes the code fragments that have been found to be replicated in the
                code.
                ...
                <p />
                You expand and collapse the code fragments using the + buttons. You can also
                navigate to the source code by clicking
                on the file names.
                <p />
                <table>
                                    ...
                                    <tr>
                                        <td valign="top">
                                            <button class="ExpandButton">
                                                <xsl:attribute name="onclick">blur();
                                                    toggleCodeSection(this, 'frag_<xsl:value-of
                                                        select="position()" />')
                                                </xsl:attribute>
                                                +
                                            </button>
