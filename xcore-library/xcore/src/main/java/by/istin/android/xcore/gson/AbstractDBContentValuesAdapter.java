...
public class AbstractDBContentValuesAdapter<T> extends AbstractValuesAdapter<T> {
    ...
    public AbstractDBContentValuesAdapter(Class<?> contentValuesClass, DataSourceRequest dataSourceRequest, IDBContentProviderSupport dbContentProvider) {
    ...
    public AbstractDBContentValuesAdapter(Class<?> contentValuesClass, DataSourceRequest dataSourceRequest, IDBConnection dbConnection, DBHelper dbHelper) {
        super(contentValuesClass);
    ...
    public AbstractDBContentValuesAdapter(Class<?> contentValuesClass, AbstractDBContentValuesAdapter dbContentValuesAdapter) {
        super(contentValuesClass);
        this.dbConnection = dbContentValuesAdapter.getDbConnection();
        this.dbHelper = dbContentValuesAdapter.getDbHelper();
        this.dataSourceRequest = dbContentValuesAdapter.dataSourceRequest;
        this.beforeListUpdate = ReflectUtils.getInstanceInterface(contentValuesClass, IBeforeArrayUpdate.class);
    }
